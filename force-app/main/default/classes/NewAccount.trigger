...
trigger NewAccount on Account (after insert) {
    ...
    if (a.AccountBalance__c > 0)
        Project0Banking.newTransaction(a.ID,Project0Banking.DEPOSIT,a.AccountBalance__c);
    ...
    if (a.AccountBalance__c < 0)
        Project0Banking.newTransaction(a.ID,Project0Banking.WITHDRAW,a.AccountBalance__c);
